...
use Aena\Bundle\Entity\Compania;
use Aena\Bundle\Form\CompaniaType;
...
class CompaniaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AenaBundle:Compania')->findAll();
     ...
     * @Method("POST")
     * @Template("AenaBundle:Compania:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AenaBundle:Compania')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AenaBundle:Compania:edit.html.twig")
     */
